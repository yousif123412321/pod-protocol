...
const { findAgentPDA, findMessagePDA, hashPayload, getMessageTypeId } = require("../sdk/dist/index.js");
...
async function debug() {
  try {
    ...
    if (!pdaMatch) {
      ...
      console.log("   This indicates the manual calculation doesn't match the SDK.");
      console.log("   Always use findMessagePDA() from the SDK for consistency.");
    }
