...
import { CommandContext, BroadcastOptions, ListOptions, ParticipantsOptions, MessagesOptions } from "./types.js";
...
export class ChannelCommands {
  ...
  private setupCreateCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("create channel", async (client, wallet, globalOpts, options) => {
  ...
  private setupInfoCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("fetch channel info", async (client, wallet, globalOpts, channelId) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
  ...
  private setupListCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("list channels", async (client, wallet, globalOpts, options) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
  ...
  private setupJoinCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("join channel", async (client, wallet, globalOpts, channelId) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
  ...
  private setupLeaveCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("leave channel", async (client, wallet, globalOpts, channelId) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
  ...
  private setupBroadcastCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("broadcast message", async (client, wallet, globalOpts, channelId, message, options) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
          await handlers.handleBroadcast(channelId, message, options as BroadcastOptions);
        })
      );
  }
  ...
  private setupInviteCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("send invitation", async (client, wallet, globalOpts, channelId, invitee) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
  ...
  private setupParticipantsCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("fetch participants", async (client, wallet, globalOpts, channelId, options) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
          await handlers.handleParticipants(channelId, options as ParticipantsOptions);
        })
      );
  }
  ...
  private setupMessagesCommand(channel: Command): void {
    channel
      ...
      .action(
        createCommandHandler("fetch messages", async (client, wallet, globalOpts, channelId, options) => {
          const context: CommandContext = { client, wallet, globalOpts };
          const handlers = new ChannelHandlers(context);
          await handlers.handleMessages(channelId, options as MessagesOptions);
        })
      );
  }
}
